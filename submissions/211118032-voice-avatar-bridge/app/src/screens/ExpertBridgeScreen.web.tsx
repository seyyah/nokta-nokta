...
/**
 * ExpertBridgeScreen.web — web platformu için iframe versiyonu.
 * Native versiyon WebView, web versiyonu iframe kullanıyor; aynı Jitsi
 * lobby + meet UI'ı.
 */
    ...
    <View style={[styles.root, { paddingTop: insets.top }]}>
      <View style={styles.header}>
        ...
        <View style={styles.headerCenter}>
          <Text style={styles.headerTitle}>Uzman Köprüsü (web)</Text>
      ...
      {!joined && (
        <View style={styles.lobby}>
          ...
          <View style={styles.linkBox}>
            <Text style={styles.linkText}>https://meet.jit.si/{roomName}</Text>
          </View>
          <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  headerClose: { color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold, width: 32 },
  headerCenter: { flex: 1, alignItems: 'center' },
  headerTitle: { color: Colors.white, fontSize: FontSize.md, fontWeight: FontWeight.semibold },
  headerSub: { color: '#cbd5e1', fontSize: FontSize.xs, marginTop: 2 },
  headerAction: { color: '#60a5fa', fontSize: FontSize.sm, fontWeight: FontWeight.semibold, width: 64, textAlign: 'right' },
  lobby: { flex: 1, padding: Spacing.lg, gap: Spacing.md },
  lobbyTitle: { color: Colors.white, fontSize: FontSize.xl, fontWeight: FontWeight.bold, textAlign: 'center', marginTop: Spacing.lg },
  lobbyBody: { color: '#cbd5e1', fontSize: FontSize.sm, textAlign: 'center', lineHeight: 20 },
  linkBox: {
    backgroundColor: '#1e293b',
  ...
  linkText: { color: '#60a5fa', fontSize: FontSize.sm, fontFamily: 'monospace', textAlign: 'center' },
  joinBtn: {
  ...
  joinText: { color: Colors.white, fontSize: FontSize.lg, fontWeight: FontWeight.bold },
  shareBtn: { paddingVertical: Spacing.sm, alignItems: 'center' },
  shareText: { color: '#60a5fa', fontSize: FontSize.sm, fontWeight: FontWeight.medium },
  hint: {
  ...
  hintTitle: { color: '#86efac', fontSize: FontSize.sm, fontWeight: FontWeight.semibold, marginBottom: 4 },
  hintItem: { color: '#bbf7d0', fontSize: FontSize.xs },
  ...
  leaveText: { color: Colors.white, fontSize: FontSize.md, fontWeight: FontWeight.semibold },
});
